...
/*
 * streamResult function takes url and name to build url path and cb and errCb
 * to call callbacks upon successful/unsuccessful stream result object and returns
 * cancelStream function for unsubscribing
 *
 * */
...
/*
 * streamResults function takes url and name to build url path and cb and errCb
 * to call callbacks upon successful/unsuccessful stream result objects and returns
 * cancelStream function for unsubscribing
 *
 * */
