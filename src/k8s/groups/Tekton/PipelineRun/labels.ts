export const PIPELINE_RUN_LABEL_SELECTOR_PARENT_PIPELINE_RUN = 'app.edp.epam.com/parentPipelineRun';
export const PIPELINE_RUN_LABEL_SELECTOR_CODEBASE_BRANCH = 'app.edp.epam.com/codebasebranch';
