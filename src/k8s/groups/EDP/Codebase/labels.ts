...
export const CODEBASE_LABEL_SELECTOR_GIT_SERVER = 'app.edp.epam.com/gitserver';
export const CODEBASE_LABEL_SELECTOR_CODEMIE_INTEGRATION = 'app.edp.epam.com/integration';
