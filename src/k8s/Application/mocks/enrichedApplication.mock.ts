          ...
          helm: {
            parameters: [
              ...
              },
              {
                ...
                value:
                  'registry.eks-sandbox.aws.main.edp.projects.epam.com/test-namespace/test-app-name',
              },
            ],
  ...
  applicationImageStreams: [
    {
      ...
      spec: {
        ...
        imageName: '01234567890.dkr.ecr.eu-central-1.amazonaws.com/test-namespace/test-app-name',
        tags: [
          {
