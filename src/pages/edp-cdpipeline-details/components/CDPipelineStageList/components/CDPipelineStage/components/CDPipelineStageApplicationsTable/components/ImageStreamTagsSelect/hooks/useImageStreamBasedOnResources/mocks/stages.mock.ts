...
export const stagesMock: DeepPartial<EDPCDPipelineStageKubeObjectInterface>[] = [
    {
        apiVersion: 'v2.edp.epam.com/v1',
        kind: 'Stage',
        metadata: {
            annotations: {
                'app.edp.epam.com/test-python-2': 'main-1.0.0-1',
            ...
            resourceVersion: '340865883',
            uid: '898119f1-a323-4e0e-b04f-90ea56a88fde',
        },
        spec: {
            cdPipeline: 'vp-test-jenkins-pipe',
            description: 'sit descr',
