...
import { ArgoCDCISecretMock } from '../../k8s/groups/default/Secret/mocks/argo-cd-ci-secret.mock';
...
test('renders ManageArgoCD Edit component', () => {
  render(
    <TestWrapper>
      <ManageArgoCD
        secret={ArgoCDCISecretMock as unknown as SecretKubeObjectInterface}
        quickLink={{
