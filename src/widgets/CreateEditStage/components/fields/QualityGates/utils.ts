export const createQualityGateTypeFieldName = (idx: number): string => `quality-gate-type-${idx}`;
export const createQualityGateStepNameFieldName = (idx: number): string =>
  `quality-gate-step-name-${idx}`;
